...
export const paymentsAPI = {
    listPayments: (params = {}) => api.get('/payments/payments/', { params }),
    getPayment: (id) => api.get(`/payments/payments/${id}/`),
    createPayment: (data) => api.post('/payments/payments/', data),
    getSummary: () => api.get('/payments/payments/summary/'),
    detailedLedger: (partnerId) => 
        api.get(`/payments/payments/detailed_ledger/?partner_id=${partnerId}`),
    createRazorpayOrder: (data) => api.post('/payments/payments/create_razorpay_order/', data),
    verifyPayment: (data) => api.post('/payments/payments/verify_payment/', data),
};
